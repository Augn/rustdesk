...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_omendesk_password_tip", "Overenie hesla omendesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aktualizujte klienta omendesk na verziu {} alebo novšiu na vzdialenej strane!"),
