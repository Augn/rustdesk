...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete omendesk..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), omendesk diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare omendesk a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a omendesk su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a omendesk su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a omendesk de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada omendesk]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep omendesk background service", "Mantene su servìtziu de omendesk in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione omendesk, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a omendesk sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a omendesk."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de omendesk."),
        ...
        ("verify_rustdesk_password_tip", "Cunfirma sa crae de omendesk"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare omendesk e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Atualiza omendesk Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de omendesk comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae omendesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana omendesk est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de omendesk"),
        ...
        ("About omendesk", "Informatziones subra de omendesk"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Atualiza su cliente omendesk remotu a sa versione {} o prus noa!"),
        ...
        ("allow-insecure-tls-fallback-tip", "De manera predefinida, omendesk averguat su certificadu de su serbidore pro sos protocollos chi impreant TLS.\nCun custa optzione ativada, omendesk at a brincare s'averguada e at a sighire in casu de faddina de averguada."),
        ("Disable UDP", "Disabìlita UDP"),
        ("disable-udp-tip", "Controllat si impreare petzi su TCP.\nCun custa optzione ativada, omendesk no at a impreare prus sa UDP 21116, ma at a impreare sa TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: su serbidore OSS de omendesk non includet custa funtzione."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk no podet acèdere a sa sessione de iscrivania in su dispositivu remotu, controlla chi una sessione siat ativa e chi omendesk la potzat impreare"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk no at pòdidu otènnere una schermada impreabile dae XDG Desktop Portal, sa libreria PipeWire podet èssere tropu betza"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk no at pòdidu carrigare unu cumponente de GStreamer netzessàriu pro registrare sa schermada ({})"),
