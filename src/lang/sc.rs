...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep omendesk background service", "Mantene su servìtziu de RustDesk in s'isfundu"),
        ...
        ("About omendesk", "Informatziones subra de RustDesk"),
