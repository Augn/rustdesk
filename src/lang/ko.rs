...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Configure", "구성"),
        ("config_acc", "데스크톱을 원격으로 제어하려면 omendesk에 \"접근성\" 권한을 부여해야 합니다."),
        ("config_screen", "데스크톱에 원격으로 액세스하려면 omendesk에 \"화면 녹화\" 권한을 부여해야 합니다."),
        ("Installing ...", "설치 중..."),
        ("Install", "설치하기"),
        ("Installation", "설치"),
        ...
        ("config_input", "키보드로 원격 데스크톱을 제어하려면 omendesk에 \"입력 모니터링\" 권한을 부여해야 합니다."),
