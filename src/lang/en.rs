...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the omendesk network..."),
        ...
        ("install_tip", "Due to UAC, omendesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install omendesk to the system."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow omendesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [omendesk Input] service."),
        ...
        ("doc_mac_permission", "https://omendesk.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next omendesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant omendesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant omendesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running omendesk."),
        ...
        ("verify_omendesk_password_tip", "Verify omendesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use omendesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Please upgrade omendesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://omendesk.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent omendesk from running properly as controlled side."),
        ...
        ("floating_window_tip", "It helps to Keep omendesk background service"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Please upgrade the omendesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, omendesk verifies the server certificate for protocols using TLS.\nWith this option enabled, omendesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, omendesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: omendesk server OSS doesn't include this feature."),
