...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "UAC 會導致 omendesk 在某些情況下無法正常作為遠端端點運作。若要避開 UAC，請點選下方按鈕將 omendesk 安裝到系統中。"),
        ("Click to upgrade", "點選以升級"),
        ("Configure", "設定"),
        ("config_acc", "為了遠端控制您的桌面，您需要授予 omendesk「無障礙功能」權限。"),
        ("config_screen", "為了遠端存取您的桌面，您需要授予 omendesk「螢幕錄製」權限。"),
        ("Installing ...", "正在安裝..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ...
        ("android_input_permission_tip1", "為了讓遠端裝置能夠透過滑鼠或觸控控制您的 Android 裝置，您需要允許 omendesk 使用「輔助功能」服務。"),
        ("android_input_permission_tip2", "請前往下一個系統設定頁面，找到並進入「已安裝的服務」，開啟「omendesk Input」服務。"),
        ...
        ("Turned off", "已關閉"),
        ("Language", "語言"),
        ("Keep omendesk background service", "保持 omendesk 後台服務"),
        ("Ignore Battery Optimizations", "忽略電池最佳化"),
        ("android_open_battery_optimizations_tip", "如果您想要停用此功能，請前往下一個 omendesk 應用程式設定頁面，找到並進入「電池」，取消勾選「不受限制」。"),
        ("Start on boot", "開機時啟動"),
        ...
        ("config_input", "為了能夠透過鍵盤控制遠端桌面，請給予 omendesk「輸入監控」權限。"),
        ("config_microphone", "為了支援透過麥克風進行音訊傳輸，請給予 omendesk「錄音」權限。"),
        ...
        ("still_click_uac_tip", "依然需要遠端使用者在執行 omendesk 時於 UAC 視窗點選「是」。"),
        ...
        ("View Mode", "瀏覽模式"),
        ("verify_rustdesk_password_tip", "驗證 omendesk 密碼"),
        ...
        ("{} sessions", "{} 個工作階段"),
        ("scam_title", "您可能遭遇詐騙！"),
        ("scam_text1", "如果您正在和素不相識的人通話，而對方要求您使用 omendesk 啟用服務，請勿繼續操作並立即掛斷電話。"),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "請升級專業版伺服器到{}或更高版本！"),
        ...
        ("selinux_tip", "SELinux 處於啟用狀態，omendesk 可能無法作為被控端正常運作。"),
        ("Change view", "更改檢視方式"),
        ("Big tiles", "大磁磚"),
        ("Small tiles", "小磁磚"),
        ("List", "清單"),
        ...
        ("allow-only-conn-window-open-tip", "只在 omendesk 視窗開啟時允許連接"),
        ...
        ("floating_window_tip", "有助於保持 omendesk 後台服務"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "請將遠端 omendesk 客戶端升級到 {} 或更新版本！"),
        ...
        ("allow-insecure-tls-fallback-tip", "預設情況下，對於使用 TLS 的協定，omendesk 會驗證伺服器的憑證。\n啟用此選項後，在驗證失敗時，omendesk 將轉為跳過驗證步驟並繼續連接。"),
        ("Disable UDP", "停用 UDP"),
        ("disable-udp-tip", "控制是否僅使用 TCP。\n啟用此選項後，omendesk 將不再使用 UDP 21116，而是使用 TCP 21116。"),
        ("server-oss-not-support-tip", "注意：omendesk 開源伺服器 (OSS server) 不包含此功能。"),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk 無法存取遠端裝置的桌面工作階段，請確認工作階段已啟動且 omendesk 可以使用它"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk 無法從 XDG Desktop Portal 取得可用的螢幕，PipeWire 函式庫可能過舊"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk 無法載入螢幕擷取所需的 GStreamer 元件 ({})"),
