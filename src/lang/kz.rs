...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "omendesk Server Pro'ны {} немесе одан жаңа нұсқаға жаңартуды өтінеміз!"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Қашықтағы жақтағы omendesk клиентін {} немесе одан жоғары нұсқаға жаңартуды өтінеміз!"),
