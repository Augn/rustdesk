...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do omendesk..."),
        ...
        ("login_required_to_connect", "Login necessário para conectar a dispositivos remotos"),
        ...
        ("install_tip", "Devido ao UAC, o omendesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o omendesk no sistema."),
        ("Click to upgrade", "Iniciar atualização"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao omendesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao omendesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o omendesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [omendesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep omendesk background service", "Manter o serviço do omendesk executando em segundo plano"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do omendesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do omendesk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do omendesk."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do omendesk"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o omendesk e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o omendesk funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por omendesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do omendesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço omendesk em segundo plano"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Atualize o cliente omendesk para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o omendesk verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o omendesk ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o omendesk não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor omendesk OSS não inclui este recurso."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "O omendesk não consegue acessar a sessão da área de trabalho no dispositivo remoto, verifique se há uma sessão da área de trabalho em execução e se o omendesk pode acessá-la."),
