...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til omendesk-nettverket..."),
        ...
        ("login_required_to_connect", "Pålogging kreves for å koble til eksterne enheter"),
        ...
        ("install_tip", "På grunn av UAC kan omendesk ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere omendesk på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi omendesk \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi omendesk \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi omendesk mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [omendesk Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for omendesk-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi omendesk tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi omendesk tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende omendesk."),
        ...
        ("verify_rustdesk_password_tip", "Verifiser omendesk-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke omendesk og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Vennligst oppgrader omendesk Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre omendesk i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av omendesk"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis omendesk-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde omendesk-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Vennligst oppgrader omendesk-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer omendesk serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil omendesk falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil omendesk ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: omendesk server OSS inkluderer ikke denne funksjonen."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk får ikke tilgang til skrivebordsøkten på den eksterne enheten, kontroller at en økt kjører og at omendesk kan bruke den"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk fikk ingen brukbar skjerm fra XDG Desktop Portal, PipeWire-biblioteket kan være for gammelt"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk kunne ikke laste en GStreamer-komponent som kreves for skjermopptak ({})"),
