...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Hazır"),
        ("Established", "Quruldu"),
        ("connecting_status", "omendesk şəbəkəsinə qoşulur..."),
        ...
        ("install_tip", "UAC səbəbindən omendesk bəzi hallarda uzaq tərəf kimi düzgün işləyə bilmir. UAC-dan yayınmaq üçün aşağıdakı düyməyə basaraq omendesk-i sistemə quraşdırın."),
        ("Click to upgrade", "Yeniləmək üçün klikləyin"),
        ("Configure", "Konfiqurasiya et"),
        ("config_acc", "Masaüstünüzü uzaqdan idarə etmək üçün omendesk-ə \"Əlçatanlıq\" icazələrini verməlisiniz."),
        ("config_screen", "Masaüstünüzə uzaqdan giriş üçün omendesk-ə \"Ekran Yazısı\" icazələrini verməlisiniz."),
        ...
        ("android_input_permission_tip1", "Uzaq cihazın siçan və ya toxunuşla Android cihazınızı idarə etməsi üçün omendesk-ə \"Əlçatanlıq\" xidmətindən istifadə icazəsi verməlisiniz."),
        ("android_input_permission_tip2", "Növbəti sistem parametrləri səhifəsinə keçin, [Quraşdırılmış xidmətlər] bölməsini tapıb açın və [omendesk Input] xidmətini işə salın."),
        ...
        ("Language", "Dil"),
        ("Keep omendesk background service", "omendesk fon xidmətini işlək saxla"),
        ("Ignore Battery Optimizations", "Batareya optimallaşdırmalarını nəzərə alma"),
        ("android_open_battery_optimizations_tip", "Bu funksiyanı söndürmək istəyirsinizsə, növbəti omendesk tətbiq parametrləri səhifəsinə keçin, [Batareya] bölməsini tapıb açın və [Məhdudiyyətsiz] seçimini götürün"),
        ...
        ("Show omendesk", "omendesk-i göstər"),
        ("This PC", "Bu kompüter"),
        ("or", "və ya"),
        ...
        ("config_input", "Uzaq masaüstünü klaviatura ilə idarə etmək üçün omendesk-ə \"Giriş Monitorinqi\" icazələrini verməlisiniz."),
        ("config_microphone", "Uzaqdan danışmaq üçün omendesk-ə \"Audio Yazısı\" icazələrini verməlisiniz."),
        ...
        ("still_click_uac_tip", "Yenə də uzaq istifadəçinin işləyən omendesk-in UAC pəncərəsində OK düyməsini basması tələb olunur."),
        ...
        ("verify_rustdesk_password_tip", "omendesk parolunu doğrula"),
        ...
        ("scam_text1", "Tanımadığınız və ETİBAR ETMƏDİYİNİZ biri telefonda sizdən omendesk işlətməyi və xidməti başlatmağı xahiş edirsə, davam etməyin və dərhal telefonu bağlayın."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "omendesk Server Pro-nu {} və ya daha yeni versiyaya yüksəldin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux aktivdir, bu, omendesk-in idarə olunan tərəf kimi düzgün işləməsinə mane ola bilər."),
        ...
        ("powered_by_me", "omendesk ilə işləyir"),
        ...
        ("allow-only-conn-window-open-tip", "Əlaqəyə yalnız omendesk pəncərəsi açıq olduqda icazə ver"),
        ...
        ("floating_window_tip", "omendesk fon xidmətini işlək saxlamağa kömək edir"),
        ...
        ("About omendesk", "omendesk haqqında"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Uzaq tərəfdə omendesk klientini {} və ya daha yeni versiyaya yüksəldin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standart olaraq omendesk TLS işlədən protokollar üçün server sertifikatını yoxlayır.\nBu seçim aktiv olduqda, yoxlama alınmadığı halda omendesk yoxlama addımını keçib davam edəcək."),
        ("Disable UDP", "UDP-ni söndür"),
        ("disable-udp-tip", "Yalnız TCP işlədilib işlədilməyəcəyini idarə edir.\nBu seçim aktiv olduqda omendesk artıq UDP 21116 işlətməyəcək, əvəzində TCP 21116 işlədiləcək."),
        ("server-oss-not-support-tip", "QEYD: omendesk server OSS bu funksiyanı əhatə etmir."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", ""),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", ""),
