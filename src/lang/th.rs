...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_omendesk_password_tip", "ยืนยันความถูกต้องรหัสผ่านของ omendesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "กรุณาอัปเดต omendesk ไคลเอนต์ไปยังเวอร์ชัน {} หรือใหม่กว่าที่ฝั่งปลายทาง!"),
