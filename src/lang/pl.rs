...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("login_required_to_connect", "Wymagane logowanie, aby połączyć się ze zdalnymi urządzeniami"),
        ...
        ("install_tip", "omendesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować omendesk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić omendesk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić omendesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [omendesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep omendesk background service", "Zachowaj usługę omendesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji omendesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z omendesk w Twojej sieci."),
        ...
        ("verify_rustdesk_password_tip", "Weryfikuj hasło omendesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu omendesk - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Proszę zaktualizować omendesk Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu omendesk po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez omendesk"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno omendesk jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę omendesk w tle"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient omendesk do wersji {} lub nowszej!"),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk nie może uzyskać dostępu do sesji pulpitu na urządzeniu zdalnym, sprawdź, czy sesja działa i czy omendesk może z niej korzystać"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk nie uzyskał użytecznego ekranu z XDG Desktop Portal, biblioteka PipeWire może być zbyt stara"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk nie mógł załadować składnika GStreamer wymaganego do przechwytywania ekranu ({})"),
