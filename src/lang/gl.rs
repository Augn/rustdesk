...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando á rede de omendesk..."),
        ...
        ("install_tip", "Debido ao UAC, omendesk non pode funcionar axeitadamente como lado remoto nalgúns casos. Para evitar o UAC, preme o botón de abaixo para instalar omendesk no sistema."),
        ("Click to upgrade", "Preme para anovar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para poder controlar o teu escritorio remotamente, cómpre conceder a omendesk permisos de «Accesibilidade»."),
        ("config_screen", "Para poder acceder ao teu escritorio remotamente, cómpre conceder a omendesk permisos de «Gravación de pantalla»."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto poida controlar o teu dispositivo Android mediante rato ou táctil, cómpre permitirlle a omendesk usar o servizo de «Accesibilidade»."),
        ("android_input_permission_tip2", "Por favor, vai á páxina de axustes do sistema seguinte, busca e entra en [Servizos instalados], e activa o servizo [Entrada de omendesk]."),
        ...
        ("Language", "Idioma"),
        ("Keep omendesk background service", "Manter o servizo de omendesk en segundo plano"),
        ("Ignore Battery Optimizations", "Ignorar as optimizacións de batería"),
        ("android_open_battery_optimizations_tip", "Se queres desactivar esta función, vai á páxina seguinte de axustes do aplicativo omendesk, busca e entra en [Batería] e desmarca [Sen restricións]"),
        ...
        ("config_input", "Para poder controlar o escritorio remoto co teclado, cómpre conceder a omendesk permisos de «Monitorización de entrada»."),
        ("config_microphone", "Para poder falar remotamente, cómpre conceder a omendesk permisos de «Gravar audio»."),
        ...
        ("still_click_uac_tip", "Aínda require que o usuario remoto prema Aceptar na ventá de UAC de omendesk en execución."),
        ...
        ("verify_rustdesk_password_tip", "Verificar o contrasinal de omendesk"),
        ...
        ("scam_text1", "Se estás ao teléfono con alguén que NON coñeces E no que NON confías que che pediu que uses omendesk e inicies o servizo, non continúes e colga inmediatamente."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Por favor, anova omendesk Server Pro á versión {} ou máis recente!"),
        ...
        ("selinux_tip", "SELinux está activado no teu dispositivo, o que podería impedir que omendesk funcione axeitadamente como lado controlado."),
        ...
        ("powered_by_me", "Desenvolvido con omendesk"),
        ...
        ("allow-only-conn-window-open-tip", "Só permitir a conexión se a ventá de omendesk está aberta"),
        ...
        ("floating_window_tip", "Axuda a manter o servizo de omendesk en segundo plano"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Por favor, anova o cliente de omendesk á versión {} ou máis recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "De maneira predeterminada, omendesk verifica o certificado do servidor para os protocolos que usan TLS.\nCon esta opción activada, omendesk omitirá o paso de verificación e continuará en caso de fallo de verificación."),
        ("Disable UDP", "Desactivar UDP"),
        ("disable-udp-tip", "Controla se usar só TCP.\nCando esta opción estea activada, omendesk xa non usará o porto UDP 21116; no seu lugar usarase o porto TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: O servidor de código aberto (OSS) de omendesk non inclúe esta funcionalidade."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk non pode acceder á sesión de escritorio do dispositivo remoto, comprobe que hai unha sesión en marcha e que omendesk pode usala"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk non puido obter unha pantalla utilizable do XDG Desktop Portal, a biblioteca PipeWire pode ser demasiado antiga"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk non puido cargar un compoñente de GStreamer necesario para capturar a pantalla ({})"),
