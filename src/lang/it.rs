...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete omendesk..."),
        ...
        ("login_required_to_connect", "Accesso necessario per connettersi a dispositivi remoti"),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), omendesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare omendesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a omendesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a omendesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a omendesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [omendesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep omendesk background service", "Mantieni il servizio di omendesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione omendesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show omendesk", "Visualizza omendesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a omendesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a omendesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di omendesk."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password omendesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare omendesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Aggiorna omendesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di omendesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da omendesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra omendesk è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio omendesk in background."),
        ...
        ("About omendesk", "Info su omendesk"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Aggiorna il client omendesk remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, omendesk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, omendesk salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, omendesk non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: il sistema operativo del server omendesk non include questa funzionalità."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk non riesce a raggiungere la sessione desktop nel dispositivo remoto, controlla che sia in esecuzione una sessione desktop e che omendesk possa usarla"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk non è riuscito a ottenere una schermata usabile dal portale desktop XDG, la libreria PipeWire potrebbe essere troppo vecchia"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk non è riuscito a caricare un componente GStreamer necessario per l'acquisizione dello schermo ({})"),
