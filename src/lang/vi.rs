...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới omendesk..."),
...
<<<<<<< HEAD
        ("install_tip", "Do UAC, omendesk sẽ không thể hoạt động đúng cách là bên từ xa trong vài trường hợp. Để tránh UAC, hãy nhấn cái nút dưới đây để cài omendesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để có thể điều khiển máy tính từ xa, bạn cần phải cung cấp quyền \"Trợ năng\" cho omendesk"),
        ("config_screen", "Để có thể truy cập máy tính từ xa, bạn cần phải cung cấp quyền \"Ghi Màn Hình\" cho omendesk."),
        ...
        ("install_tip", "Do cơ chế UAC, omendesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt omendesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho omendesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho omendesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [omendesk Input]."),
        ...
        ("Language", "Ngôn ngữ"),
<<<<<<< HEAD
        ("Keep omendesk background service", "Giữ dịch vụ nền omendesk"),
        ("Ignore Battery Optimizations", "Bỏ qua tối ưu hóa pin"),
        ("android_open_battery_optimizations_tip", "Nếu bạn muốn tắt tính năng này, vui lòng chuyển đến trang cài đặt ứng dụng omendesk tiếp theo, tìm và nhập [Pin], Bỏ chọn [Không hạn chế]"),
...
<<<<<<< HEAD
        ...
        ("config_input", "Để điều khiển được máy tính từ xa với bàn phím, bạn cần cho phép omendesk quyền \"Theo dõi đầu vào\" (Input Monitoring)"),
        ("config_microphone", "Để nói chuyện từ xa, bạn phải cho phép omendesk quyền \"Ghi âm thanh\" (Record Audio)"),
...
<<<<<<< HEAD
        ...
        ("still_click_uac_tip", "Vẫn cần người dùng từ xa nhấn OK trên cửa sổ UAC của omendesk đang chạy."),
...
>>>>>>> upstream/master
        ...
        ("verify_omendesk_password_tip", "Xác thực mật khẩu omendesk"),
        ...
        ("scam_text2", "Chỉ sử dụng omendesk với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ omendesk mở"),
        ...
        ("floating_window_tip", "Giữ omendesk trên cùng"),
...
=======
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
