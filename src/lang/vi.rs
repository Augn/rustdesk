...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu omendesk"),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk không thể truy cập phiên màn hình nền trên thiết bị từ xa, hãy kiểm tra rằng một phiên đang chạy và omendesk có thể dùng nó"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk không lấy được màn hình dùng được từ XDG Desktop Portal, thư viện PipeWire có thể quá cũ"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk không thể tải một thành phần GStreamer cần cho việc ghi màn hình ({})"),
