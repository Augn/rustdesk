...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red omendesk en progreso..."),
        ...
        ("login_required_to_connect", "Se requiere inicio de sesión para conectarse a dispositivos remotos"),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que omendesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar omendesk a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a omendesk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a omendesk de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que omendesk use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [omendesk Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep omendesk background service", "Dejar omendesk como Servicio en 2do plano"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a omendesk permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a omendesk permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de omendesk"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses omendesk e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "¡Por favor, actualiza omendesk Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que omendesk no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de omendesk"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de omendesk de fondo"),
        ...
        ("About omendesk", "Acerca de omendesk"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Por favor, actualiza el cliente omendesk a la versión {} o superior en el lado remoto"),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, omendesk verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, omendesk volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, omendesk no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: El servidor omendesk OSS no incluye esta característica."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk no puede acceder a la sesión de escritorio del dispositivo remoto; compruebe que hay una sesión en marcha y que omendesk puede usarla"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk no ha podido obtener una pantalla utilizable del XDG Desktop Portal; la biblioteca PipeWire puede ser demasiado antigua"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk no ha podido cargar un componente de GStreamer necesario para capturar la pantalla ({})"),
