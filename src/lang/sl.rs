...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_omendesk_password_tip", "Preveri geslo za omendesk"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite omendesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
