...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem omendesk..."),
        ...
        ("login_required_to_connect", "Prijava je potrebna za povezavo z oddaljenimi napravami"),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, omendesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate omendesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate omendesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno omendesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »omendesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep omendesk background service", "Ohrani omendeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije omendesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "omendesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "omendesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za omendesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite omendesk, prekinite klic in program zaprite."),
        ("scam_text2", "omendesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Prosimo, nadgradite omendesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo omendesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno omendeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri omendesk storitvi v ozadju"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Prosimo, nadgradite omendesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto omendesk preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo omendesk ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, omendesk ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik omendesk OSS ne vključuje te funkcije."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk ne more dostopati do namizne seje na oddaljeni napravi, preverite, ali seja teče in ali jo omendesk lahko uporablja"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk od XDG Desktop Portala ni dobil uporabnega zaslona, knjižnica PipeWire je morda prestara"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk ni mogel naložiti komponente GStreamer, potrebne za zajem zaslona ({})"),
