...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ju lutemi përmirësoni omendesk Server Pro në versionin {} ose më të ri!"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Ju lutemi përmirësoni klientin omendesk në versionin {} ose më të ri në anën në distancë!"),
