...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til omendesk-netværket..."),
        ...
        ("login_required_to_connect", "Login kræves for at oprette forbindelse til eksterne enheder"),
        ...
        ("install_tip", "På grund af UAC kan omendesk ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere omendesk på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give omendesk \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give omendesk \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give omendesk mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [omendesk Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep omendesk background service", "Behold omendesk baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn omendesk appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia-grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open source-driveren, og aktivere software-rendering. En genstart af omendesk er nødvendig."),
        ("Always use software rendering", "Brug altid software-rendering"),
        ("config_input", "For at styre fjernskrivebordet med tastaturet, skal du give omendesk rettigheder til at optage tastetryk"),
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give omendesk rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC-vinduet ved kørsel af omendesk."),
        ...
        ("verify_rustdesk_password_tip", "Bekræft omendesk-adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge omendesk til at forbinde til din PC, så stop med det samme, og læg på omgående."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Opgradér venligst omendesk Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, hvilket kan forhindre omendesk i at køre normalt."),
        ...
        ("powered_by_me", "Drives af omendesk"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af omendesk med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis omendesk-vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper til at holde omendesk-baggrundstjenesten kørende"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Opgrader venligst omendesk-klienten til version {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verificerer omendesk servercertifikatet for protokoller, der bruger TLS.\nNår denne indstilling er aktiveret, vil omendesk springe verificeringstrinnet over og fortsætte, hvis verificeringen mislykkes."),
        ("Disable UDP", "Deaktivér UDP"),
        ("disable-udp-tip", "Bestemmer, om der kun skal bruges TCP.\nNår denne indstilling er aktiveret, vil omendesk ikke længere bruge UDP 21116; i stedet bruges TCP 21116."),
        ("server-oss-not-support-tip", "BEMÆRK: omendesk Server OSS indeholder ikke denne funktion."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk kan ikke nå skrivebordssessionen på fjernenheden, kontrollér at en session kører, og at omendesk kan bruge den"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk kunne ikke få en brugbar skærm fra XDG Desktop Portal, PipeWire-biblioteket er måske for gammelt"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk kunne ikke indlæse en GStreamer-komponent, der kræves til skærmoptagelse ({})"),
