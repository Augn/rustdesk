...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open-source driveren, og aktivere software rendering. Et genstart af omendesk er nødvendigt."),
        ...
        ("verify_omendesk_password_tip", "Bekræft omendesk adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge omendesk til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre omendesk i at køre normalt."),
        ...
        ("floating_window_tip", "Det hjælper på at omendesk baggrundstjenesten kører"),
