...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na omendesk mrežu..."),
        ...
        ("login_required_to_connect", "Prijavljivanje je potrebno za povezivanje sa udaljenim uređajima"),
        ...
        ("install_tip", "Zbog UAC omendesk ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate omendesk na sistem."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfigurisanje"),
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, omendesk-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, omendesk-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite omendesk-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [omendesk Input] servis."),
        ...
        ("Language", "Jezik"),
        ("Keep omendesk background service", "Zadrži omendesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje omendesk aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("Show omendesk", "Prikazi omendesk"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
        ("Elevate", "Izdigni"),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite omendesk-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite omendesk-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog omendesk-a."),
        ...
        ("verify_rustdesk_password_tip", "Potvrdi omendesk lozinku"),
        ...
        ("scam_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite omendesk i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Molimo nadogradite omendesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti omendesk da radi pravilno kao kontrolisana strana."),
        ...
        ("powered_by_me", "Pokreće omendesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je omendesk prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se omendesk pozadinski servis održi"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Molimo nadogradite omendesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Podrazumevano, omendesk proverava sertifikat servera za protokole koji koriste TLS.\nSa omogućenom ovom opcijom, omendesk će preskočiti korak provere i nastaviti u slučaju neuspele provere."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Kontroliše da li se koristi samo TCP.\nKada je ova opcija omogućena, omendesk više neće koristiti UDP 21116, umesto toga će se koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: omendesk server OSS ne uključuje ovu funkciju."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk ne može da pristupi sesiji radne površine na udaljenom uređaju, proverite da li sesija radi i da li omendesk može da je koristi"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk nije mogao da dobije upotrebljiv ekran od XDG Desktop Portala, PipeWire biblioteka je možda prestara"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk nije mogao da učita GStreamer komponentu potrebnu za snimanje ekrana ({})"),
