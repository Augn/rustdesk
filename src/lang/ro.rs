...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua omendesk..."),
        ...
        ("login_required_to_connect", "Este necesară autentificarea pentru a te conecta la dispozitive la distanță"),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca omendesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala omendesk."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți omendesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți omendesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți omendesk să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [omendesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep omendesk background service", "Rulează serviciul omendesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației omendesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show omendesk", "Afișează omendesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi omendesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi omendesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din omendesk care rulează."),
        ...
        ("verify_rustdesk_password_tip", "Verifică parola omendesk"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi omendesk pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Versiunea serverului omendesk Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul omendesk pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu omendesk"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web omendesk Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări omendesk. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About omendesk", "Despre omendesk"),
        ...
        ("web_id_input_tip", "Introdu ID-ul omendesk al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Versiunea clientului omendesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește omendesk Pro pentru funcționalitate completă."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk nu poate accesa sesiunea de desktop de pe dispozitivul de la distanță, verificați dacă o sesiune rulează și dacă omendesk o poate folosi"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk nu a putut obține un ecran utilizabil de la XDG Desktop Portal, biblioteca PipeWire poate fi prea veche"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk nu a putut încărca o componentă GStreamer necesară pentru capturarea ecranului ({})"),
