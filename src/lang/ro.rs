...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți omendesk să utilize serviciul „Accesibilitate”."),
        ...
        ("verify_omendesk_password_tip", "Verifică parola omendesk"),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", ""),
