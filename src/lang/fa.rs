...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("login_required_to_connect", "برای اتصال به دستگاه‌های از راه دور نیاز به ورود است"),
        ...
        ("install_tip", "لطفا برنامه را نصب کنید UAC و جلوگیری از خطای omendesk برای راحتی در استفاده از نرم افزار"),
        ("Click to upgrade", "برای ارتقا کلیک کنید"),
        ("Configure", "تنظیم"),
        ("config_acc", "بدهید \"access\" مجوز omendesk برای کنترل از راه دور دسکتاپ باید به"),
        ("config_screen", "بدهید \"screenshot\" مجوز omendesk برای کنترل از راه دور دسکتاپ باید به"),
        ...
        ("android_input_permission_tip1", "استفاده کند \"Accessibility\" اجازه دهید از ویژگی omendesk شما را از طریق ماوس یا صفحه ی لمسی کنترل کند، باید به Android برای اینکه یک دستگاه از راه دور بتواند دستگاه"),
        ("android_input_permission_tip2", "را پیدا کنید و فعال نمایید \"omendesk Input\" بشوید ، سپس گزینه \"Installed Services\" وارد قسمت \"Accessibility\" در صفحه تنظیمات "),
        ...
        ("Turned off", "خاموش شد"),
        ("Language", "زبان"),
        ("Keep omendesk background service", "را در پس زمینه نگه دارید omendesk سرویس"),
        ...
        ("config_input", "برای کنترل دسکتاپ از راه دور با صفحه کلید، باید مجوز omendesk \"Input Monitoring\" را بدهید."),
        ("config_microphone", "را بدهید. omendesk \"Record Audio\" برای صحبت از راه دور، باید مجوز"),
        ...
        ("still_click_uac_tip", "همچنان کاربر از راه دور نیاز دارد که روی OK در پنجره UAC اجرای omendesk کلیک کند."),
        ...
        ("verify_rustdesk_password_tip", "رمز عبور omendesk را تأیید کنید"),
        ...
        ("scam_text1", "استفاده کنید و سرویس را راه‌اندازی کنید، صحبت می‌کنید، ادامه ندهید و بلافاصله تلفن را قطع کنید omendesk اگر با شخصی که نمی‌شناسید و به او اعتماد ندارید و از شما خواسته است از"),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "را به نسخه {} یا جدیدتر ارتقا دهید omendesk Server Pro لظفا"),
        ...
        ("selinux_tip", "به عنوان کنترل شده جلوگیری کند omendesk روی دستگاه شما فعال است ، که ممکن است از اجرای صحیح SELinux"),
        ...
        ("powered_by_me", "Powered by omendesk"),
        ...
        ("allow-only-conn-window-open-tip", "باز است اتصال برقرار شود omendesk زمانی که"),
        ...
        ("floating_window_tip", "کمک می کند omendesk این به حفظ سرویس پس زمینه"),
        ...
        ("About omendesk", "omendesk درباره"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "لطفاً omendesk را به نسخه {} یا جدیدتر در سمت راه دور ارتقا دهید"),
        ...
        ("allow-insecure-tls-fallback-tip", "به‌طور پیش‌فرض، omendesk گواهی سرور را برای پروتکل‌ها با استفاده از TLS تأیید می‌کند.\nبا فعال بودن این گزینه، omendesk دوباره مرحله تأیید را رد می‌کند و در صورت عدم موفقیت تأیید ادامه می‌دهد."),
        ("Disable UDP", "UDP غیر فعال کردن"),
        ("disable-udp-tip", "کنترل می کند که آیا فقط از TCP استفاده شود یا خیر.\nوقتی این گزینه فعال باشد، omendesk دیگر از UDP 21116 استفاده نمی کند، به جای آن از TCP 21116 استفاده می شود."),
        ("server-oss-not-support-tip", "توجه: سرور omendesk OSS این ویژگی را ندارد."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk نمی‌تواند به نشست میزکار دستگاه راه دور دسترسی پیدا کند، بررسی کنید که نشست میزکار در حال اجرا باشد و omendesk بتواند از آن استفاده کند"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk نتوانست صفحه‌ای قابل استفاده از XDG Desktop Portal دریافت کند، ممکن است کتابخانه PipeWire خیلی قدیمی باشد"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk نتوانست مؤلفه GStreamer موردنیاز برای ضبط صفحه را بارگذاری کند ({})"),
