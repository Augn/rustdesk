...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke omendesk..."),
        ...
        ("login_required_to_connect", "Login diperlukan untuk terhubung ke perangkat jarak jauh"),
        ...
        ("install_tip", "Karena UAC, omendesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal omendesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk omendesk."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk omendesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd omendesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input omendesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep omendesk background service", "Pertahankan omendesk berjalan pada service background"),
        ...
        ("Show omendesk", "Tampilkan omendesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada omendesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada omendesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC omendesk yang sedang berjalan"),
        ...
        ("verify_rustdesk_password_tip", "Verifikasi Kata Sandi omendesk"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan omendesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Silahkan perbarui omendesk Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah omendesk berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh omendesk"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela omendesk sedang terbuka."),
        ...
        ("floating_window_tip", "Untuk menjaga layanan/service omendesk agar tetap aktif"),
        ...
        ("About omendesk", "Tentang omendesk"),
        ...
        ("upgrade_remote_omendesk_client_to_{}_tip", "Silahkan perbarui aplikasi omendesk ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Secara default, omendesk memverifikasi sertifikat server untuk protokol yang menggunakan TLS.\nDengan opsi ini diaktifkan, omendesk akan kembali melewati langkah verifikasi dan melanjutkan jika verifikasi gagal."),
        ("Disable UDP", "Nonaktifkan UDP"),
        ("disable-udp-tip", "Mengontrol apakah hanya menggunakan TCP.\nSaat opsi ini diaktifkan, omendesk tidak akan menggunakan UDP 21116 lagi, TCP 21116 akan digunakan sebagai gantinya."),
        ("server-oss-not-support-tip", "CATATAN: omendesk server OSS tidak menyertakan fitur ini."),
        ...
        ("omendesk cannot reach the desktop session on the remote device, check that a desktop session is running and that omendesk can use it", "omendesk tidak dapat mengakses sesi desktop di perangkat jarak jauh, pastikan sesi desktop berjalan dan dapat digunakan oleh omendesk"),
        ...
        ("omendesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "omendesk tidak mendapatkan layar yang dapat digunakan dari XDG Desktop Portal, pustaka PipeWire mungkin terlalu lama"),
        ("omendesk could not load a GStreamer component needed for screen capture ({})", "omendesk tidak dapat memuat komponen GStreamer yang diperlukan untuk merekam layar ({})"),
