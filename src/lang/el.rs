...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("login_required_to_connect", "Απαιτείται σύνδεση για να συνδεθείτε σε απομακρυσμένες συσκευές"),
        ...
        ("config_acc", "Για τον απομακρυσμένο έλεγχο του υπολογιστή σας, πρέπει να εκχωρήσετε δικαιώματα πρόσβασης στο omendesk."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στον υπολογιστή σας, πρέπει να εκχωρήσετε το δικαίωμα omendesk \"Screen Capture\"."),
        ...
        ("android_input_permission_tip2", "Παρακαλώ μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος omendesk]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep omendesk background service", "Εκτέλεση του omendesk στο παρασκήνιο"),
        ...
        ("Show omendesk", "Εμφάνιση omendesk"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με πληκτρολόγιο, πρέπει να εκχωρήσετε δικαιώματα στο omendesk"),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο OK στο παράθυρο UAC όπου εκτελείται το omendesk."),
        ...
        ("verify_omendesk_password_tip", "Επιβεβαιώστε τον κωδικό του omendesk"),
        ...
        ("upgrade_omendesk_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε τον omendesk Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Έχετε ενεργοποιημένο το SELinux, το οποίο πιθανόν εμποδίζει την ορθή λειτουργία του omendesk."),
        ...
        ("powered_by_me", "Με την υποστήριξη της omendesk"),
